...
public class TorusTest {
	...
	public void firstCrossSectionTest() {
		...
		//first point
		assertEquals(0, vertices.getData()[0], epsilon);
		...
		//third point
		assertEquals(2, vertices.getData()[6], epsilon);
	...
	public void secondCrossSectionTest() {
		...
		assertEquals(0, vertices.getData()[13], epsilon);
		...
		assertEquals(2, vertices.getData()[19], epsilon);
